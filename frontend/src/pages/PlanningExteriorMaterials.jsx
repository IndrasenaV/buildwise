...
export default function PlanningExteriorMaterials() {
  ...
  async function saveNotes() {
    try {
      ...
      console.log('Exterior materials notes (local only):', notes)
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <Stack spacing={2}>
      ...
      <Paper variant="outlined" sx={{ p: 2 }}>
        <Typography variant="h6" gutterBottom>Roofing, cladding, and openings</Typography>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
          Capture roofing (shingles/tile/metal), underlayments, siding/cladding selections, exterior trim, window/door finishes, and weatherproofing notes.
        </Typography>
        <TextField
          fullWidth
          multiline
